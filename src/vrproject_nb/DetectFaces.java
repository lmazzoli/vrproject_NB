...
public class DetectFaces {
	...
	public static void main(String[] args) {
		...
		String("https://raw.githubusercontent.com/watson-developer-cloud/doc-tutorial-downloads/master/visual-recognition/prez.jpg");
		VisualRecognitionOptions options = new
		VisualRecognitionOptions.Builder().url(imageURL).build(); 
		Object result = service.detectFaces(options).execute();
